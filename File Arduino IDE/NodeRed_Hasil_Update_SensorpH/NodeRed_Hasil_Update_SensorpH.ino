...
// Baseline NTU (hasil rata-rata air jernih dari pengukuran awal)
float baselineNTU = 110; // sesuaikan dengan hasil tes air jernih
...
void loop() {
  ...
  float ntu = 0;
  if (voltageTurbidity > 0.1) { // threshold sensor kosong
    ntu = getNTU(voltageTurbidity);
  }
